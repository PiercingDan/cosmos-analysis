...
im = ax[0].contourf(xcenters, ycenters, qfracHf, 10, alpha=1.0, cmap=pl.cm.jet)
ax[0].contour(xcenters, ycenters, qfracHf, 10, colors='black', lw=0.5)
...
#ax[0].set_title('Quiescent Fraction of Field Galaxies')
...
#Group==============================================================
im = ax[1].contourf(xcenters, ycenters, qfracHg, 10, alpha=1.0, cmap=pl.cm.jet)
ax[1].contour(xcenters, ycenters, qfracHg, 5, colors='black', lw=0.5)
...
#ax[1].set_title('Quiescent Fraction of Group Galaxies')
